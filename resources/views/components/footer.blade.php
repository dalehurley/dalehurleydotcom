...
<footer class="{{ $class }}">
    <div class="mx-auto max-w-7xl px-6 pt-16 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
        ...
        <div class="mt-16 border-t border-white/10 dark:border-gray-600/10 pt-8">
            <p class="text-sm/6 text-gray-300 dark:text-gray-400 text-center">&copy; {{ date('Y') }} Dale Hurley.
                All rights reserved. Made with ❤️ in Australia 🐨 🦘.</p>
        </div>
    </div>
</footer>
